const recipes = [
  ...
  },
  {
    ...
    title: "Café gelado",
    image:
      "https://www.receitasnestle.com.br/sites/default/files/styles/recipe_detail_desktop_new/public/srh_recipes/6ce10070ca590097bf7241c8cd5951d9.jpg?itok=u4POTa93",
    time: "10 min",
    difficulty: "Fácil",
    servings: "1 porção",
    category: "Bebidas",
  ...
  },
  {
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFoFYy5QiD_uYiCIjnNklTDFcXwD7ogq9CwA&s",
    time: "30 min",
    difficulty: "Médio",
    servings: "10 porção",
    category: "doces",
  ...
  },
  {
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCdVM9EBAzWhcCHK6NUL_uQwXTvBdWMRulXgXFtgaBFEFZTYQuFSJfb7lu&s=10",
    time: "5 min",
  ...
  },
  {
    ...
    title: "Tofu Mexido",
    image:
      "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    time: "10 min",
    difficulty: "Médio",
    servings: "2 porções",
    category: "veganas",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1505576399279-565b52d4ac71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    time: "5 min",
    difficulty: "Fácil",
    servings: "1 porção",
    category: "saudaveis",
...
function createRecipeCard(recipe) {
  ...
  card.innerHTML = `
    ...
    <div class="p-4">
      <h3 class="font-bold text-lg text-amber-700">${recipe.title}</h3>
      <p class="text-sm text-gray-600">${recipe.time} | ${recipe.difficulty} | ${recipe.servings}</p>
    </div>
  `;
...
function renderRecipes(filterCategory = "all") {
  ...
  if (filtered.length === 0) {
    recipesContainer.innerHTML = "<p class='text-center text-gray-500'>Nenhuma receita encontrada.</p>";
    return;
  }
